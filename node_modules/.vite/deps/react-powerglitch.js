...
var u = (t, i) => (Math.random() - 0.5) * 2 * p(t, i);
var $ = ({ minHeight: t, maxHeight: i, minWidth: e, maxWidth: n }) => {
...
function H(t) {
  const [i, e] = (0, import_react.useState)(t), [n, r] = (0, import_react.useState)(() => () => {
  }), [c, a] = (0, import_react.useState)(() => () => {
  });
  return {

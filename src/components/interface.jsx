...
const Video = ({ src, isLoading }) => {
  ...
  return (
    <div>
      {
        !isLoading && (<div role="status" class="flex items-center justify-center h-56 w-[90%] bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
        <svg class=" h-10 text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
